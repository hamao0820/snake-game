...
eval("\nvar __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar _Countdown_time, _Countdown_rapTime;\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Countdown {\n    constructor() {\n        _Countdown_time.set(this, void 0);\n        _Countdown_rapTime.set(this, void 0);\n        __classPrivateFieldSet(this, _Countdown_time, null, \"f\");\n        __classPrivateFieldSet(this, _Countdown_rapTime, Date.now(), \"f\");\n    }\n    // 時間を進める\n    tick() {\n        if (__classPrivateFieldGet(this, _Countdown_time, \"f\") === null)\n            throw new Error('time does not set');\n        __classPrivateFieldSet(this, _Countdown_time, __classPrivateFieldGet(this, _Countdown_time, \"f\") - (Date.now() - __classPrivateFieldGet(this, _Countdown_rapTime, \"f\")), \"f\");\n        __classPrivateFieldSet(this, _Countdown_rapTime, Date.now(), \"f\");\n    }\n    // 時間を設定する\n    set time(time) {\n        __classPrivateFieldSet(this, _Countdown_rapTime, Date.now(), \"f\");\n        __classPrivateFieldSet(this, _Countdown_time, time, \"f\");\n    }\n    get countDown() {\n        if (__classPrivateFieldGet(this, _Countdown_time, \"f\") === null)\n            throw new Error('time does not set');\n        return Math.ceil(__classPrivateFieldGet(this, _Countdown_time, \"f\") / 1000);\n    }\n}\n_Countdown_time = new WeakMap(), _Countdown_rapTime = new WeakMap();\nexports[\"default\"] = Countdown;\n\n\n//# sourceURL=webpack://snake-game/./src/ts/countdown.ts?");
...
/***/ "./src/ts/startButton.ts":
/*!*******************************!*\
  !*** ./src/ts/startButton.ts ***!
  \*******************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("\nvar __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nvar _a, _StartButton_element;\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst game_1 = __importDefault(__webpack_require__(/*! ./game */ \"./src/ts/game.ts\"));\nclass StartButton {\n    static init(game) {\n        __classPrivateFieldSet(this, _a, document.getElementById('start'), \"f\", _StartButton_element);\n        __classPrivateFieldGet(this, _a, \"f\", _StartButton_element).onclick = () => this.start(game);\n    }\n    static start(game) {\n        this.unavailable();\n        __classPrivateFieldGet(this, _a, \"f\", _StartButton_element).onclick = null;\n        game.ready();\n    }\n    static restart() {\n        this.unavailable();\n        const game = new game_1.default();\n        game.init();\n        this.start(game);\n    }\n    static unavailable() {\n        __classPrivateFieldGet(this, _a, \"f\", _StartButton_element).classList.add('unavailable');\n    }\n    static available() {\n        __classPrivateFieldGet(this, _a, \"f\", _StartButton_element).classList.remove('unavailable');\n        __classPrivateFieldGet(this, _a, \"f\", _StartButton_element).onclick = () => this.restart();\n    }\n}\n_a = StartButton;\n_StartButton_element = { value: void 0 };\nexports[\"default\"] = StartButton;\n\n\n//# sourceURL=webpack://snake-game/./src/ts/startButton.ts?");
