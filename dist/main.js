...
eval("\nvar __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nvar _View_model;\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst snake_1 = __importDefault(__webpack_require__(/*! ./snake */ \"./src/ts/snake.ts\"));\nconst stage_1 = __importDefault(__webpack_require__(/*! ./stage */ \"./src/ts/stage.ts\"));\nclass View {\n    constructor(model) {\n        _View_model.set(this, void 0);\n        __classPrivateFieldSet(this, _View_model, model, \"f\");\n    }\n    renderStage() {\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = '#000';\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillRect(0, 0, stage_1.default.Size, stage_1.default.Size);\n    }\n    renderSnake() {\n        let i = 0;\n        for (const [x, y] of __classPrivateFieldGet(this, _View_model, \"f\").snake.positionList) {\n            __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = __classPrivateFieldGet(this, _View_model, \"f\").gameOver\n                ? '#800'\n                : `hsl(${120 - (__classPrivateFieldGet(this, _View_model, \"f\").snake.positionList.length - i) * 2}deg, 100%, 50%)`;\n            __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.beginPath();\n            __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.arc(x, y, snake_1.default.halfWidth, 0, 2 * Math.PI);\n            __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fill();\n            __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.closePath();\n            i++;\n        }\n    }\n    renderSnakeEye() {\n        const lex = __classPrivateFieldGet(this, _View_model, \"f\").snake.mx + Math.cos(((__classPrivateFieldGet(this, _View_model, \"f\").snake.angle - 60) * Math.PI) / 180) * snake_1.default.halfWidth * 0.4;\n        const ley = __classPrivateFieldGet(this, _View_model, \"f\").snake.my + Math.sin(((__classPrivateFieldGet(this, _View_model, \"f\").snake.angle - 60) * Math.PI) / 180) * snake_1.default.halfWidth * 0.4;\n        const rex = __classPrivateFieldGet(this, _View_model, \"f\").snake.mx + Math.cos(((__classPrivateFieldGet(this, _View_model, \"f\").snake.angle + 60) * Math.PI) / 180) * snake_1.default.halfWidth * 0.4;\n        const rey = __classPrivateFieldGet(this, _View_model, \"f\").snake.my + Math.sin(((__classPrivateFieldGet(this, _View_model, \"f\").snake.angle + 60) * Math.PI) / 180) * snake_1.default.halfWidth * 0.4;\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = '#fff';\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.beginPath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.arc(lex, ley, snake_1.default.halfWidth * 0.4, 0, 2 * Math.PI);\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fill();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.closePath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = '#000';\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.beginPath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.arc(lex, ley, snake_1.default.halfWidth * 0.2, 0, 2 * Math.PI);\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fill();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.closePath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = '#fff';\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.beginPath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.arc(rex, rey, snake_1.default.halfWidth * 0.4, 0, 2 * Math.PI);\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fill();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.closePath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = '#000';\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.beginPath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.arc(rex, rey, snake_1.default.halfWidth * 0.2, 0, 2 * Math.PI);\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fill();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.closePath();\n    }\n    renderFood() {\n        if (__classPrivateFieldGet(this, _View_model, \"f\").food === null) {\n            return;\n        }\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fillStyle = `hsl(${Math.random() * 360}, 100%, 50%)`;\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.beginPath();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.arc(__classPrivateFieldGet(this, _View_model, \"f\").food.x, __classPrivateFieldGet(this, _View_model, \"f\").food.y, snake_1.default.halfWidth, 0, 2 * Math.PI);\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.fill();\n        __classPrivateFieldGet(this, _View_model, \"f\").stage.ctx.closePath();\n    }\n    render() {\n        this.renderStage();\n        this.renderSnake();\n        this.renderSnakeEye();\n        this.renderFood();\n    }\n}\n_View_model = new WeakMap();\nexports[\"default\"] = View;\n\n\n//# sourceURL=webpack://snake-game/./src/ts/view.ts?");
