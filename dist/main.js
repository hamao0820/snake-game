...
eval("\nvar __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar _Model_view, _Model_snake;\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Model {\n    constructor(view, snake) {\n        _Model_view.set(this, void 0);\n        _Model_snake.set(this, void 0);\n        __classPrivateFieldSet(this, _Model_view, view, \"f\");\n        __classPrivateFieldSet(this, _Model_snake, snake, \"f\");\n    }\n    update() {\n        __classPrivateFieldGet(this, _Model_snake, \"f\").move();\n        __classPrivateFieldGet(this, _Model_view, \"f\").render();\n    }\n}\n_Model_view = new WeakMap(), _Model_snake = new WeakMap();\nexports[\"default\"] = Model;\n\n\n//# sourceURL=webpack://snake-game/./src/ts/model.ts?");
...
eval("\nvar __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar _Stage_ctx;\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Stage {\n    constructor() {\n        _Stage_ctx.set(this, void 0);\n        const canvas = document.getElementById('canvas');\n        __classPrivateFieldSet(this, _Stage_ctx, canvas.getContext('2d'), \"f\");\n    }\n    get ctx() {\n        return __classPrivateFieldGet(this, _Stage_ctx, \"f\");\n    }\n}\n_Stage_ctx = new WeakMap();\nStage.Size = 300;\nexports[\"default\"] = Stage;\n\n\n//# sourceURL=webpack://snake-game/./src/ts/stage.ts?");
...
eval("\nvar __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\n};\nvar __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nvar _View_stage, _View_snake;\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst snake_1 = __importDefault(__webpack_require__(/*! ./snake */ \"./src/ts/snake.ts\"));\nconst stage_1 = __importDefault(__webpack_require__(/*! ./stage */ \"./src/ts/stage.ts\"));\nclass View {\n    constructor(stage, snake) {\n        _View_stage.set(this, void 0);\n        _View_snake.set(this, void 0);\n        __classPrivateFieldSet(this, _View_stage, stage, \"f\");\n        __classPrivateFieldSet(this, _View_snake, snake, \"f\");\n    }\n    renderStage() {\n        __classPrivateFieldGet(this, _View_stage, \"f\").ctx.fillStyle = '#000';\n        __classPrivateFieldGet(this, _View_stage, \"f\").ctx.fillRect(0, 0, stage_1.default.Size, stage_1.default.Size);\n    }\n    renderSnake() {\n        __classPrivateFieldGet(this, _View_stage, \"f\").ctx.fillStyle = '#0c0';\n        for (const [x, y] of __classPrivateFieldGet(this, _View_snake, \"f\").positionList) {\n            __classPrivateFieldGet(this, _View_stage, \"f\").ctx.beginPath();\n            __classPrivateFieldGet(this, _View_stage, \"f\").ctx.arc(x, y, snake_1.default.halfWidth, 0, 2 * Math.PI);\n            __classPrivateFieldGet(this, _View_stage, \"f\").ctx.fill();\n            __classPrivateFieldGet(this, _View_stage, \"f\").ctx.closePath();\n        }\n    }\n    render() {\n        this.renderStage();\n        this.renderSnake();\n    }\n}\n_View_stage = new WeakMap(), _View_snake = new WeakMap();\nexports[\"default\"] = View;\n\n\n//# sourceURL=webpack://snake-game/./src/ts/view.ts?");
